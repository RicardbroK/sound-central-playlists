...
class TrackSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Track
        fields = ['track_id', 'album_title', 'album_art_url', 'artists', 'track_name', 'duration_ms', 'explicit',
                  'release_date', 'spotify_track_uri',
...
class PlaylistSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Playlist
        fields = ['playlist_id', 'user', 'fans', 'tracks', 'playlist_image', 'playlist_name', 'playlist_description',
                  'playlist_track_length',
