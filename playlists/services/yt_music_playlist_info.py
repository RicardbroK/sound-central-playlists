    ...
    def insert_playlist_db(self):
        ...
        for item in playlist_data['playlist_tracks']:
            ...
            artist, _ = Artist.objects.get_or_create(
                ...
                defaults={
                    'youtube_music_channel_uri': item['artist']['artist_youtube_uri'] if offical_artist else UNOFFICAL_ARTIST_STRING,
            ...
            if offical_artist:
                if artist.youtube_music_channel_uri is None or artist.youtube_music_channel_uri is '':
                    artist.youtube_music_channel_uri = item['artist']['artist_youtube_uri'] if item['artist']['artist_youtube_uri'] else None
                    artist.save()
